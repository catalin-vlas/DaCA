...
class TriplesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addTriplesFromFileCall(String namespaceId, File file, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addTriplesFromFileValidateBeforeCall(String namespaceId, File file, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addTriplesFromFileCall(namespaceId, file, progressListener, progressRequestListener);
        return call;
    ...
    public void addTriplesFromFile(String namespaceId, File file) throws ApiException {
        addTriplesFromFileWithHttpInfo(namespaceId, file);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> addTriplesFromFileWithHttpInfo(String namespaceId, File file) throws ApiException {
        com.squareup.okhttp.Call call = addTriplesFromFileValidateBeforeCall(namespaceId, file, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addTriplesFromFileAsync(String namespaceId, File file, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addTriplesFromFileValidateBeforeCall(namespaceId, file, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
